...
class MacanArchiver(QMainWindow):
    def __init__(self, file_to_open=None):
        ...
        # [BARU] Palet warna untuk ikon tema terang dan gelap
        self.theme_colors = {
            'dark': {
    ...
    # [MODIFIKASI] Fungsi untuk mengganti tema dan memperbarui ikon
    ...
    # [BARU] Fungsi untuk memperbarui semua ikon saat tema berubah
    def _update_all_icons(self):
        ...
        self.info_action.setIcon(self._get_themed_icon("info"))
    ...
    def _create_menus_and_toolbars(self):
        ...
        self.info_action = self._get_themed_icon("info") # [MODIFIKASI] Simpan QIcon untuk about

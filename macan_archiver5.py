...
class MacanArchiver(QMainWindow):
    def __init__(self, file_to_open=None):
        ...
        self.current_archive_type = None # [BARU] Untuk melacak tipe arsip yang dibuka
    ...
    def dropEvent(self, event):
        ...
        # [MODIFIKASI] Cek semua format yang didukung
    ...
    def _get_supported_formats_filter(self):
        # [MODIFIKASI] Menambahkan filter untuk format baru
        filters = [
    ...
    # [MODIFIKASI] Fungsi utama untuk membaca arsip, sekarang berfungsi sebagai dispatcher
    def _list_archive_contents(self, file_path):
        ...
        # Tentukan tipe arsip dan panggil fungsi yang sesuai
        try:
            ...
            # [BARU] Aktifkan/Nonaktifkan tombol berdasarkan tipe arsip
            is_7z = self.current_archive_type == '7z'
            self.test_action.setEnabled(is_7z)
            self.delete_action.setEnabled(False) # Awalnya nonaktif, akan diaktifkan saat ada seleksi
    ...
    # [BARU] Fungsi-fungsi spesifik untuk setiap format arsip
    ...
    # [MODIFIKASI] Ekstraksi sekarang menggunakan dispatcher
    ...
    def _show_context_menu(self, pos):
        ...
        # [MODIFIKASI] Hanya tampilkan menu Delete untuk arsip 7z/MCN
    ...
    def _update_status_bar(self):
        ...
        # [MODIFIKASI] Aktifkan delete hanya jika ada seleksi DAN tipenya 7z
    ...
    def _test_archive(self):
        # Fungsi ini tetap spesifik untuk 7z
    ...
    # [MODIFIKASI] Ekstraksi file terpilih sekarang juga menggunakan dispatcher
    ...
    def _show_about(self):
        # [MODIFIKASI] Menambahkan info tentang dukungan format dan dependensi
...
if __name__ == "__main__":
    ...
    # [BARU] Menambahkan pengecekan untuk dependensi rarfile saat startup
    if not RAR_SUPPORT:
